...
def split_train_test(
    ...
    df_features["day"] = pd.to_datetime(df_features["day"], dayfirst=True)
...
def fit_model(
    ...
    model.fit(df_features, verbose=True)
...
def deploy_model(
    ...
    # Here you can add some quality checks
    # based on losses or evaluation predictions
...
def main(
    ...
    # sys.path.append(os.path.dirname("/Users/riter/Development/python-workspace/karpov/hard/demand_forecast/training/"))
